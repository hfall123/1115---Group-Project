...
while True:
    ...
    #ensure that the value sbeing sent to the servos are angles within its range
    #if they are  above of below the maximum and minimum accepatble values, change this
    if elbow_angle > 180:
        elbow_angle = 180
    elif elbow_angle < 0:
        elbow_angle = 0
