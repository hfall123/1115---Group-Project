...
def inverse_kinematics(wrist_x, wrist_y):
    ...
    angle_BAC = math.acos((L1*L1 + AC**2 - L2*L2) / (2 * L1 * AC))
    #Shoulder angle
    theta_shoulder = angle_AC - angle_BAC
    #Law of cosines for elbow
    angle_elbow = math.acos((L1*L1 + L2*L2 - AC**2) / (2 * L1 * L2))
...
'''
#calibration code to account for the differences in jigs
...
print("""
        ...
        To place the pen on the paper, hit the button in the bottom middle of the expansion board labelled sw5.
